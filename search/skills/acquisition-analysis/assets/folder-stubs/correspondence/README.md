...
- `cover-letter-{date}.html` / `.pdf` — branded buyer introduction letter, drafted on analyze/evaluate
...
Keep chronological. When logging a call, capture: who, when, duration, key points, commitments made (both sides), follow-ups.
